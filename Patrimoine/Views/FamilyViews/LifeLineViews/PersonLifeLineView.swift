...
struct PersonLifeLineView: View {
    ...
    init(withInitialValueFrom member: Person) {
        viewModel.steps.append(TextView(text:member.birthDate.stringShortDayMonth + ": Naissance", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
        viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(member.birthDate.year), width: 45).eraseToAnyView()))
        ...
        switch member {
            case is Adult:
                ...
                viewModel.steps.append(TextView(text: adult.dateOfRetirement.stringShortDayMonth + ": Cessation d'activité", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
                viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(adult.dateOfRetirement.year), width: 45).eraseToAnyView()))
                ...
                viewModel.steps.append(TextView(text: adult.dateOfAgircPensionLiquid.stringShortDayMonth + ": Liquidation de la pension complémentaire", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
                viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(adult.dateOfAgircPensionLiquid.year), width: 45).eraseToAnyView()))
                ...
                viewModel.steps.append(TextView(text: adult.dateOfPensionLiquid.stringShortDayMonth + ": Liquidation de la pension de base", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
                viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(adult.dateOfPensionLiquid.year), width: 45).eraseToAnyView()))
                ...
                // liquidation de pension de base
                viewModel.steps.append(TextView(text: "Entrée dans la dépendance", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
                viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(adult.yearOfDependency), width: 45).eraseToAnyView()))
                viewModel.pitStops.append(PitStopStep(view: TextView(text:"Pension du régime général et complémentaire").eraseToAnyView(), lineOptions: PitStopLineOptions.custom(1, Colors.teal.rawValue)))
            
            case is Child:
                let child = member as! Child
                // Début des études supérieures
                viewModel.steps.append(TextView(text: child.dateOfUniversity.stringShortDayMonth + ": Début des études supérieures", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
                viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(child.dateOfUniversity.year), width: 45).eraseToAnyView()))
                ...
                viewModel.steps.append(TextView(text: child.dateOfIndependence.stringShortDayMonth + ": Indépendance financière", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
                viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(child.dateOfIndependence.year), width: 45).eraseToAnyView()))
        ...
        viewModel.steps.append(TextView(text:"Décès", font: .system(size: 14, weight: .semibold)).eraseToAnyView())
        viewModel.indicators.append(StepperIndicationType.custom(NumberedCircleView(text: String(member.yearOfDeath), width: 45).eraseToAnyView()))
